<aside>
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <p class="sidebar-header">DASHBOARD</p>

            <div class="sidebar-wrapper-text">
        ...
        <div class="sidebar-wrapper">
            <p class="sidebar-header">MASTER</p>
            ...
            <div class="sidebar-wrapper-text">
                ...
                <a href="../../../view/admin/kandidat/index.php">Kandidat</a>
            </div>
            ...
            <div class="sidebar-wrapper-text">
                ...
                <a href="../../../view/admin/pemilihan/index.php">Pemilihan</a>
            </div>
            <div class="sidebar-wrapper-text">
                ...
                <a href="../../../view/admin/pemilih/index.php">Pemilih</a>
            </div>
        </div>
    </div>
</aside>